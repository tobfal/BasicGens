...
import de.tobfal.basicgens.block.entity.BaseFluidGeneratorBlockEntity;
...
public class FluidGeneratorMenu extends AbstractContainerMenu {
    ...
    private final BaseFluidGeneratorBlockEntity blockEntity;
    ...
    public FluidGeneratorMenu(int windowId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        blockEntity = ((BaseFluidGeneratorBlockEntity) entity);
